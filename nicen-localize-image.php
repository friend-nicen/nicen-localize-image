...
define('nicen_make_PATH',plugin_dir_path(__FILE__));
define('nicen_make_URL',plugin_dir_url(__FILE__));
...
include_once nicen_make_PATH . '/admin/common.php'; //公告变量和方法
include_once nicen_make_PATH . '/response/response.php'; //公告变量和方法

/*
 * 只在后台才触发
 * */

include_once nicen_make_PATH . '/admin/load.php'; //加载插件后台资源
include_once nicen_make_PATH. '/admin/form.php'; //加载表单
include_once nicen_make_PATH . '/admin/setting.php';//渲染表单
include_once nicen_make_PATH . '/admin/initialize.php'; //初始化插件功能
include_once nicen_make_PATH . '/admin/when-post.php'; //公告变量和方法
